...
void initTonesDictionary() {
    ...
    playlistOrder[5] = "game_over_melody";
    playlistOrder[6] = "sfx";
    ...
    // Example tones
     ...
     struct Tone game_over_melody[]={{NOTE_C4,500},{NOTE_E4,500},{NOTE_G4,500},{NOTE_E4,500},{NOTE_C4,2000},{NOTE_F4,500},{NOTE_E4,500},{NOTE_D4,500},{NOTE_C4,500},{NOTE_G3,2000},{NOTE_G4,500},{NOTE_F4,500},{NOTE_E4,500},{NOTE_D4,500},{NOTE_C4,2000},{NOTE_F4,500},{NOTE_E4,500},{NOTE_D4,500},{NOTE_C4,500},{NOTE_C3,2000},{0,0}};
     struct Tone sfx[] = {{NOTE_C4,500}};
     ...
     insert(playlist, "game_over_melody", game_over_melody, sizeof(game_over_melody) / sizeof(struct Tone));
     insert(playlist, "sfx", sfx, sizeof(sfx) / sizeof(struct Tone));
 }
